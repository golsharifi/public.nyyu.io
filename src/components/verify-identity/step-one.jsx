...
import { UPLOAD_DOCUMENT } from "./kyc-webservice"; // Add this import
import {
    NewDoc,
    Pass,
    Unpass1,
...
export default function StepOne() {
    ...
    const [uploadDocumentMutation] = useMutation(UPLOAD_DOCUMENT, {
        onCompleted: (data) => {
            ...
            verification.nextStep(); // Move to next step after successful upload
        },
        onError: (error) => {
    ...
    const handleNextClick = async () => {
        ...
        try {
            ...
            // Ensure we're passing the actual File object, not a processed version
            const fileToUpload =
                    ...
                    <div className="my-5 ">
                        <div className="d-flex justify-content-center gap-3 col-md-12">
                            ...
                            <button
                                ...
                                onClick={handleNextClick} // Changed from verification.nextStep()
                            >
