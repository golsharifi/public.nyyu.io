...
import { create_Avatar_Component } from "../../../store/actions/avatarAction";
...
const IndexPage = () => {
    ...
    const avatarError = useMemo(() => {
        ...
        if (!svgFile.filename)
            return { file: "Please select avatar component" };
        return {};
    }, [category, svgFile]);
                            ...
                            <div className="input_div">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <p>
                                            Tier:{" "}
                                            <span>{avatarInfo.tier.label}</span>
                                        </p>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="profile m-auto">
